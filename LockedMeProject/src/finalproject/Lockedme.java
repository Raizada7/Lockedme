...
static final String projectFilesPath = "C:\\Users\\HP\\eclipse-workspace\\LockedMeProject";
...
do
{
displayMenu(); System.out.println("Enter your choice");
...
System.out.println("\t=================================");
System.out.println("\tDesigned by Ayush "); 
...
int linesCount;
System.out.println("Enter how many lines in the file"); linesCount = Integer.parseInt(obj.nextLine());
